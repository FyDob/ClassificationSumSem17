...
# print(lin1.score(X_test, y_test_lin))


# text_clf.fit(X_train, y_train)

# X_test = strings[-2000:]
# y_test = categories[-2000:]
	
# text_clf = Pipeline([('vect', bigram_vectorizer), ('tfidf', TfidfTransformer()), ('clf', MultinomialNB())])

# '''
# X_train = strings[:-2000]
# y_train = categories[:-2000]
...
# def train(classifier, X, y, rand_int):
    # X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.20, random_state=33-rand_int)
...
# for i in range(0,10):
	# print(str(i) + "\t NB: \n")
	# train(text_clf, strings, categories, i)
	# print(str(i) + "\tSVM: \n")
	# train(text_clf_svm, strings, categories, i)